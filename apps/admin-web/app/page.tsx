...
const API_BASE = process.env.NEXT_PUBLIC_OPENBANK_API_URL ?? "http://localhost:4000";
...
export default function AdminHome() {
  const [email, setEmail] = useState("ops@openbankng.example");
  const [password, setPassword] = useState("OpenBankAdmin!2026");
