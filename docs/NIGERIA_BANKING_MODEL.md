...
This document defines the Nigerian banking assumptions used by OpenBank NG.
...
OpenBank NG supports NUBAN-style account-number generation logic for demo/sandbox accounts.
...
Nigerian transfer rails commonly require robust status handling. OpenBank NG uses this lifecycle:
...
OpenBank NG should include adapters, not hardcoded provider dependency.
