...
Phase 9 prepares OpenBank NG for controlled buyer delivery after a marketplace or direct sale, while keeping actual access gated by MD approval.
...
Buyer handoff must state that OpenBank NG is source-code software only. It must not be represented as a licensed bank, regulated payment processor, legal/compliance certification, production security certification, direct payment-rail access, or managed production service.
