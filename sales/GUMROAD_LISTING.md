...
OpenBank NG gives buyers a serious source-code foundation so they can start from a structured fintech product instead of a blank repository.

## Product Positioning

OpenBank NG is a commercial source-code package for founders, agencies, developers, cooperatives, and licensed financial operators building Nigerian wallet, neobank, agency banking, cooperative savings, or payment products.
...
OpenBank NG must not be marketed as a licensed bank, regulated financial institution, payment processor, legal opinion, compliance certification, or production security certification. Buyers are responsible for all licenses, provider agreements, compliance review, production security review, and go-live approval.
